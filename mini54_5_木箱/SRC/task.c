...
{
	/* Init GPIO MODE */
	GPIO_SetMode(P1, BIT2, GPIO_PMD_INPUT);		//BT_REV
	GPIO_SetMode(P1, BIT0, GPIO_PMD_INPUT);		//BT_FWD
	GPIO_SetMode(P0, BIT0, GPIO_PMD_OUTPUT);		//BT_POWER
	GPIO_SetMode(P5, BIT3, GPIO_PMD_QUASI);			//BT_DET
	GPIO_SetMode(P1, BIT3, GPIO_PMD_OUTPUT);			//USB_PLAY
	GPIO_SetMode(P1, BIT4, GPIO_PMD_OUTPUT);			//USB_ON/OFF
